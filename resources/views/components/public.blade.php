...
<flux:header
    class="w-full border-b px-0! border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 flex flex-col transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
    ...
    <flux:container class="flex flex-row gap-x-10 max-w-7xl text-center justify-between py-5">
        <flux:container class="flex flex-col px-0! sm:mb-6 lg:text-left lg:mb-0 lg:pl-0">
            <h1 class="mb-4 font-bold leading-tight text-4xl">
                Royal Army Dental Corps Old Comrades
            </h1>
...
<!--footer-->
<flux:footer
    class="w-full p-5 border-t border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 flex flex-col">
