    ...
    <flux:container
        ...
        <flux:container class="flex w-full flex-col px-0! items-start">
            ...
            <flux:container
                ...
                <!--history-->
                <flux-container class="flex shrink flex-col justify-between flex-1 md:basis-1/4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    ...
                    <flux:container class="p-3! flex-1 grow-0">
                        <a href="{{ route('history') }}">
                            <flux:button variant="danger" icon-trailing="arrow-right" aria-label="Read more about the corps history">
                                Read more
                            </flux:button>
                        </a>
                    </flux:container>
                ...
                <flux-container class="flex shrink flex-col justify-between flex-1 md:basis-1/4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    ...
                    <flux:container class="p-3! flex-1 grow-0">
                        <a href="{{ route('chapel') }}">
                            <flux:button variant="danger" icon-trailing="arrow-right" aria-label="Read more about the corps chapel">
                                Read more
                            </flux:button>
                        </a>
                    </flux:container>
                ...
                <flux-container class="flex shrink flex-col justify-between flex-1 md:basis-1/4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    ...
                    <flux:container class="p-3! flex-1 grow-0">
                        <a href="{{ route('memorial') }}">
                            <flux:button variant="danger" icon-trailing="arrow-right" aria-label="Read more about the corps memorial">
                                Read more
                            </flux:button>
                        </a>
                    </flux:container>
                ...
                <flux-container class="flex shrink flex-col justify-between flex-1 md:basis-1/4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    ...
                    <flux:container class="p-3! flex-1 grow-0">
                        <a href="{{ route('museum') }}">
                            <flux:button variant="danger" icon-trailing="arrow-right" aria-label="Read more about the museum of military medicine">
                                Read more
                            </flux:button>
                        </a>
                    </flux:container>
