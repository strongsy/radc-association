<x-layouts.front-end title="The Museum of Military Medicine">
    <flux:container
        ...
        <flux:heading size="xl" level="1" class="mb-5 flex flex-row">The Museum of Military Medicine
        </flux:heading>
    </flux:container>
    ...
    <flux:container
        ...
        <flux:container class="flex px-0! w-full flex-col items-start">
            <flux:text class="leading-relaxed">
                <img src="{{ asset('storage/images/museum/museum02.png') }}"
        ...
        <flux:container class="flex px-0! w-full flex-col items-start">
            <flux:text class="leading-relaxed">
                <img src="{{ asset('storage/images/museum/museum01.png') }}"
        ...
        <flux:container class="flex px-0! w-full flex-col items-start">
            <flux:text class="leading-relaxed">
                <img src="{{ asset('storage/images/museum/museum03.png') }}"
