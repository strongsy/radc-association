<x-layouts.front-end title="About the Amalgamation">
    ...
    <flux:container
        ...
        <flux:heading size="xl" level="1" class="mb-5 flex flex-row">About the Amalgamation
        </flux:heading>
    </flux:container>
    ...
    <flux:container
        ...
        <flux:container class="flex flex-col items-start mb-6 not-italic">
            <flex:container class="mb-8 inline-flex items-start mr-3 text-sm text-gray-900 dark:text-white">
                <img class="mr-4 w-16 h-16 rounded-full" src="{{ asset('storage/images/about/about-img01.png') }}"
                     alt="Ewan Carmichael">
                <flex:container>
